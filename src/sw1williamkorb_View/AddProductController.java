...
public class AddProductController {
    ...
    private void SaveBtnHandler(ActionEvent event){
        ...
        alert.setHeaderText("You are about to add this product to the inventory.");
        alert.setContentText("Do you wish to continue?");
        ...
        if (valid){
            tempproduct.setProductID(Product.generateID());
    ...
    private void AddSelectedPartBtnHandler(ActionEvent event){
        //ignores request if selected part is already associated
        if (!tempproduct.associatedParts.contains(partsTable.getSelectionModel().getSelectedItem())){
