...
public class ModPartController {
    ...
    public void initialize() {   
        ...
        //if the part is inhouse, set the form up with inhouse values
        if (MainMenuController.getTempPart() instanceof InhousePart){
            IDLabel.setText(Integer.toString(MainMenuController.getTempInhousePart().getPartID()));
            NameField.setText(MainMenuController.getTempInhousePart().getPartName());
            CostField.setText(Double.toString(MainMenuController.getTempInhousePart().getPartCost()));
            InvLvlField.setText(Integer.toString(MainMenuController.getTempInhousePart().getInStock()));
            MachineIDField.setText(Integer.toString(MainMenuController.getTempInhousePart().getMachineID()));
            MaxField.setText(Integer.toString(MainMenuController.getTempInhousePart().getMax()));
            MinField.setText(Integer.toString(MainMenuController.getTempInhousePart().getMin()));
        ...
        //if the part is outsourced, set up the form with outsourced values
        if (MainMenuController.getTempPart() instanceof OutsourcedPart){
            IDLabel.setText(Integer.toString(MainMenuController.getTempOutsourcedPart().getPartID()));
            NameField.setText(MainMenuController.getTempOutsourcedPart().getPartName());
            CostField.setText(Double.toString(MainMenuController.getTempOutsourcedPart().getPartCost()));
            InvLvlField.setText(Integer.toString(MainMenuController.getTempOutsourcedPart().getInStock()));
            CompanyNameField.setText(MainMenuController.getTempOutsourcedPart().getCompanyName());
            MaxField.setText(Integer.toString(MainMenuController.getTempOutsourcedPart().getMax()));
            MinField.setText(Integer.toString(MainMenuController.getTempOutsourcedPart().getMin()));
    ...
    private void SaveBtnHandler(ActionEvent event) throws IOException{
        ...
        alert.setHeaderText("Changes to this part will be saved to the inventory.");
        alert.setContentText("Do you wish to continue?");
        ...
        //remove the old part
        int partID = MainMenuController.getTempPart().getPartID();
        ...
        if (InHouseRadioBtn.isSelected()){
            ...
            InhousePart newpart = new InhousePart(partID, name, Double.parseDouble(cost), Integer.parseInt(invlvl), Integer.parseInt(min), Integer.parseInt(max), Integer.parseInt(machineID));
            ...
            OutsourcedPart newpart = new OutsourcedPart(partID, name, Double.parseDouble(cost), Integer.parseInt(invlvl), Integer.parseInt(min), Integer.parseInt(max), company);
            Inventory.addPart(newpart);
        }
        else {
